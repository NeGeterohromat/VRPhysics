...
namespace VRKeys {
	...
	public class Keyboard : MonoBehaviour {
        public Vector3 firstKeyPosition = new Vector3(-0.675f, 0f, 0.3f);
		...
		private IEnumerator SetupKeys () {
			bool activeKeyboardState = keysParent.gameObject.activeSelf;
            bool activeCanvasState = canvas.activeSelf;
			...
			for (int i = 0; i < layout.row1Keys.Length; i++) {
                ...
                obj.transform.localPosition += firstKeyPosition;
			...
			canvas.SetActive (activeCanvasState);
			keysParent.gameObject.SetActive (activeKeyboardState);
		}
